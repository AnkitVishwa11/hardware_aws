  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 pb-2">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-sm sm:text-base font-mono font-extrabold tracking-wide text-slate-900 uppercase">
              EXECUTIVE COMMAND CENTER
            </h2>
            {isDemo && (
              <span className="rounded bg-amber-100 px-1.5 py-0.2 text-[9px] font-mono font-bold tracking-wider text-amber-800 border border-amber-300">
                1S LIVE SIMULATION
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-1.5 text-xs font-mono text-slate-600 self-start sm:self-auto bg-white px-2.5 py-1 rounded-lg border border-slate-200 shadow-2xs">
          <Clock className="h-3 w-3 text-sky-600" />
          <span className="text-[11px]">Last Sync:</span>
          <span className="font-bold text-slate-900 text-xs">{lastUpdatedTime}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-shadow relative overflow-hidden">
          <div className="flex items-center justify-between text-slate-500">
            <div className="flex items-center gap-1.5">
              <div className="rounded-md p-1.5 bg-sky-50 text-sky-600 border border-sky-200">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[11px] font-mono text-slate-500 font-semibold">cm Δ</span>
            </div>
            <span className="text-[10px] font-mono text-slate-400">Base: 22.0cm</span>
          </div>

          <div className="mt-1.5 text-[9px] font-mono text-slate-500 border-t border-slate-100 pt-1.5 flex items-center justify-between">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-shadow relative overflow-hidden">
          <div className="flex items-center justify-between text-slate-500">
            <div className="flex items-center gap-1.5">
              <div className="rounded-md p-1.5 bg-amber-50 text-amber-600 border border-amber-200">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[11px] font-mono text-slate-500 font-semibold">°</span>
            </div>
            <span className="text-[10px] font-mono text-slate-400">Pitch / Roll</span>
          </div>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-shadow relative overflow-hidden">
          <div className="flex items-center justify-between text-slate-500">
            <div className="flex items-center gap-1.5">
              <div className="rounded-md p-1.5 bg-purple-50 text-purple-600 border border-purple-200">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[11px] font-mono text-slate-500 font-semibold">g RMS</span>
            </div>
            <span className="text-[10px] font-mono text-slate-400">Limit: 0.35g</span>
          </div>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-shadow relative overflow-hidden">
          <div className="flex items-center justify-between text-slate-500">
            <div className="flex items-center gap-1.5">
              <div className="rounded-md p-1.5 bg-emerald-50 text-emerald-600 border border-emerald-200">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[11px] font-mono text-slate-500 font-semibold">ADC</span>
            </div>
            <span className="text-[10px] font-mono text-slate-400">Scale: 0-1023</span>
          </div>

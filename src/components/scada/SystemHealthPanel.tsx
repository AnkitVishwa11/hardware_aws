  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
        ...
        <div className="flex items-center gap-2 font-mono text-[11px] text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 font-semibold">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 font-mono text-xs">
        ...
        <div className="rounded-lg bg-slate-50 p-3 border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-[10px] uppercase font-semibold">Node MCU</span>
        ...
        <div className="rounded-lg bg-slate-50 p-3 border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-[10px] uppercase font-semibold">Wi-Fi Gateway</span>
        ...
        <div className="rounded-lg bg-slate-50 p-3 border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-[10px] uppercase font-semibold">Cloud Host</span>
        ...
        <div className="rounded-lg bg-slate-50 p-3 border border-slate-200 flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-[10px] uppercase font-semibold">Sensor Bus</span>
            <ShieldCheck className="h-3.5 w-3.5 text-teal-600" />
          </div>
          <span className="text-xs text-slate-900 font-bold block">Sensor Network</span>
          <span className="text-emerald-700 font-bold text-[11px] flex items-center gap-1 mt-1">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> 4/4 ACTIVE
          </span>
        </div>

        {/* Last Data Packet */}
        <div className="rounded-lg bg-slate-50 p-3 border border-slate-200 flex flex-col justify-between col-span-2 sm:col-span-1">
          <div className="flex items-center justify-between text-slate-500 mb-1">
            <span className="text-[10px] uppercase font-semibold">Last Packet</span>
            <Clock className="h-3.5 w-3.5 text-slate-400" />
          </div>
          <span className="text-xs text-slate-900 font-bold block">Sync Timestamp</span>
          <span className="text-slate-800 font-bold text-[11px] mt-1">
            {lastUpdatedTime}
          </span>
        </div>
      </div>
